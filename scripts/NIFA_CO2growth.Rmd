...
```{r, eval=FALSE}
ggsave(wgresp_plot, file="../figures/fig_wgresp.svg", units="mm", height=90, width=180, device="svg")
```
...
# Overall
cor.test(wgrr_avg$weighted_g, wgrr_avg$resp_rate_co2)
...
```{r, eval=FALSE}
ggsave(greff_plot, file="../figures/plot_greff.svg", units="mm", height=90, width=180, device="svg")
```
...
```{r, eval=FALSE}
ggsave(wggreff_plot, file="../figures/fig_wggreff.svg", units="mm", height=90, width=180, device="svg")
```
