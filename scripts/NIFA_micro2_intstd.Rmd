...
```{r}
# Micro2 test data
count <- read_tsv("../data_amplicon/NIFA_micro2/final/NIFA_micro2.counts-final.tsv")
tax <- read_tsv("../data_amplicon/NIFA_micro2/final/NIFA_micro2.taxonomy-final.tsv")
meta <- read_tsv("../NIFA_micro2_metadata.tsv") %>% 
