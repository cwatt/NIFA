...
```{r, eval=FALSE}
ggsave(subnum_plot, file="../figures/fig_subnum.svg", units="mm", height=50, width=120, device="svg") 
```
...
```{r, eval=FALSE}
ggsave(subpref_plot, file="../figures/fig_subpref.svg", units="mm", height=50, width=120, device="svg")
```
...
abundtotal0_plot <- abund_total0_nice %>% 
...
```{r, eval=FALSE}
ggsave(abundtotal0_plot, file="../figures/fig_abundtotal0.svg", units="mm", width=110, height=90, device="svg")
```
...
```{r, eval=FALSE}
ggsave(prop0_plot, file="../figures/fig_abundprop0.svg", units="mm", width=110, height=90, device="svg")
```
